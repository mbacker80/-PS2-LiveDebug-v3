...
{
ee_kmode_enter();
*(u32*)0x80044500 = 0x4C2D4C43; // CL-LiveDebug v3
*(u32*)0x80044504 = 0x44657669;
*(u32*)0x80044508 = 0x67756265;
*(u32*)0x8004450C = 0x00337620;

*(u32*)0x80044510 = 0x61657243; // Created by: Gtlcpimp
...
*(u32*)0x80044528 = 0x69736956; // Visit us at www.Cheaters-Lounge.net
...
*(u32*)0x8004454C = 0x6961462A; // *Fail-Safe mode* Press 'START' to enter the menu.
...
*(u32*)0x80044580 = 0x6E654D3D; // =Menu Controls=
*(u32*)0x80044584 = 0x6F432075;
*(u32*)0x80044588 = 0x6F72746E;
*(u32*)0x8004458C = 0x003D736C;

*(u32*)0x80044590 = 0x41207055; // Up Arrow: Address - 4
...
*(u32*)0x800445A8 = 0x6E776F44; // Down Arrow: Address + 4
...
*(u32*)0x80044634 = 0x63746150; // Patches
*(u32*)0x80044638 = 0x00736568;

*(u32*)0x8004463C = 0x7466654C; // Left Arrow - Left 1 Digit
...
*(u32*)0x80044658 = 0x68676952; // Right Arrow - Right 1 Digit
...
*(u32*)0x80044674 = 0x41207055; // Up Arrow - Increment 1 Bit
...
*(u32*)0x80044690 = 0x6E776F44; // Down Arrow - Decrement 1 Bit
...
*(u32*)0x800446B0 = 0x736F7243; // Cross - Go To Address
...
*(u32*)0x800446C8 = 0x63726943; // Circle - Cancel
*(u32*)0x800446CC = 0x2D20656C;
*(u32*)0x800446D0 = 0x6E614320;
*(u32*)0x800446D4 = 0x006C6563;

*(u32*)0x800446D8 = 0x61757153; // Square: Line Selector
...
*(u32*)0x80044840 = 0x696C6E49; // Inline Test
*(u32*)0x80044844 = 0x5420656E;
*(u32*)0x80044848 = 0x00747365;

*(u32*)0x8004484C = 0x30303030; // 00000000 00000000
*(u32*)0x80044850 = 0x30303030;
*(u32*)0x80044854 = 0x30303020;
*(u32*)0x80044858 = 0x30303030;
*(u32*)0x8004485C = 0x00000030;
